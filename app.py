...
st.title("Assistente Virtual de Manuais de Produtos e Sistemas em PDF")
...
template_prompt="""
    ...
    Sua tarefa é analisar o contexto ainda que esteja em inglês, mas sempre responder a pergunta do usuário OBRIGATORIAMENTE EM PORTUGUÊS DO BRASIL.
